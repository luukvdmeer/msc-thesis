...
# 1.4 Approach
The bike availability forecasting system as proposed in this thesis extends the methodology proposed by @formentin2015, and uses the distance based approach. That is, the distance to the nearest available bike will be the variable of interest. The distance based approached is chosen, because it has the following advantages over the grid based approach.
