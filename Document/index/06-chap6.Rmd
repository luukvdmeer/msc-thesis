...
In future studies that adress the same problem, the forecast accuracy may be improved by incuding exogeneous variables, related to weather conditions and special events, which can explain some of the uncaptured variation. Furthermore, methodolgies to provide sensible prediction intervals, need to be developed.
