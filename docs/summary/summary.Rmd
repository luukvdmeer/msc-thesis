...
- A lot of things!
- Among those: a <span style = 'color:#fc8c01;'>reliable</span> system
...
# Created a generally applicable methodology to forecast bike availability in dockless bike sharing systems. It outperforms baseline methods, but also highlights the limited forecastability of dockless bike sharing data.
